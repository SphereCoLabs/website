    ...
    <div className="p-3 bg-white rounded border">
      <div className="flex justify-between items-start">
        ...
        <div className="text-xs text-gray-500">
          Reward:{" "}
          {campaign?.reward ? `${Number(campaign.reward) / 1e18} ETH` : "0 ETH"}
        </div>
      </div>
    </div>
  );
          ...
          <div>
            ...
            {campaign && (
              <div className="mt-4">
                ...
                <p>
                  <strong>Brief:</strong> {campaign.brief || "No brief"}
                </p>
                <p>
                  <strong>Goal:</strong> {campaign.goal || "No goal"}
                </p>
                <p>
                ...
                <p>
                  ...
                  {campaign.reward
                    ? `${Number(campaign.reward) / 1e18} ETH`
                    : "No reward"}
                </p>
                <p>
